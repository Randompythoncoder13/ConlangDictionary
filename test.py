...
class SetProjectNameUpdateErrorWizard(QWizard):
    ...
    def on_wizard_complete(self, result):
        ...
        new_location = os.path.join(self.info_parent.app_data_dir, name)
        os.makedirs(new_location, exist_ok=True)

        if os.path.exists(self.info_parent.dictionary_file):
            os.rename(self.info_parent.dictioary_file, os.path.join(new_location, "conlang_dictionary.json"))

        if os.path.exists(self.info_parent.tags_file):
            os.rename(self.info_parent.tags_file, os.path.join(new_location, "conlang_tags.json"))

        if os.path.exists(self.info_parent.grammer_file):
            os.rename(self.info_parent.grammer_file, os.path.join(new_location, "conlang_grammer.json"))
